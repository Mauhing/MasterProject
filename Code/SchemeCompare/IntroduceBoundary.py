...
Gap=50          #Set to 1 if you want histogram to recorde all the timestep.
...
hist_M2=hist_M2.T
#
#hist_M2=hist_M2/np.mean(hist_M2, axis=0)
#plt.plot(hist_M2[:,-1], midpoints, linewidth=0.5, label= "Milstein_2")
