...
#%%
#Part 1
# OpenMPI rank 0 makes diffusivity the plot.
if (rank==0):
    ...
    plt.plot(Constant,z, label="Variable diffusivity")
    plt.gca().invert_yaxis()
    plt.xlabel("Diffusivity (m$^2$/s)")
    plt.ylabel("Depth (m)")
    plt.tight_layout()
    plt.legend()
    print("Close the graph and precee", flush=True)
    plt.show()
