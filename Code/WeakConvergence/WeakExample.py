...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 18 12:28:11 2018
...
H=25.0
dtEu=0.1
dtLa=1  #dt for particle scheme
T=12*3600 #one hours
w=0
Np=200000             #Number of particles
...
for i in range(Ntp):
    ...
    print("\r","working with", i," of ",Ntp, end="\r", flush=True)
...
fig=plt.figure(1)
plt.plot(zEu,Conc)   
plt.plot(midpoints,hist,"o",alpha=0.3)
#plt.plot(zEu,ConcInit)
#plt.plot(midpoints,hist_start,alpha=0.3)
plt.show()
